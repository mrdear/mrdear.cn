...
cover: https://res.mrdear.cn/mybatis.png
author: 
  nick: 屈定
tags:
  - Mybatis    
...
![](https://res.mrdear.cn/1505020777.png)
...
```
![](https://res.mrdear.cn/1505023031.png?imageMogr2/thumbnail/!70p)

#### SqlNode
SqlNode是动态Sql解析和完善`ContextMap`的地方,对于我上述sql会转换为其三个子类,相关解析方法都在其内部.
![](https://res.mrdear.cn/1505027107.png?imageMogr2/thumbnail/!70p)
解析后的sql如下图
```sql
...
![](https://res.mrdear.cn/1505027407.png)
...
![](https://res.mrdear.cn/1505526788.png?imageMogr2/thumbnail/!70p)
