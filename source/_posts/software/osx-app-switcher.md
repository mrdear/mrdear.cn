...
cover: https://res.mrdear.cn/uPic/MAC-Hammerspoon.png-default
author: 
  nick: 屈定
tags:
  - OSX
...
快捷键切换是使用最频繁的场景，因此为了达到完美体验，我总结了以下流程图，流程图的原则是定位到不同的应用，不存在则启动应用，存在则切换到该应用，同时应对多屏幕下多窗口，多次相同快捷键能够在窗口之间互相切换。![](https://res.mrdear.cn/uPic/mac-app-switch.png-default "")
