...
cover: https://res.mrdear.cn/mrdearblog_pro_git.png
author: 
  nick: 屈定
tags:
  - 读书笔记
...
![](https://res.mrdear.cn/1540091450.png)

**2. git add**
添加到暂存区，本质上是把本地目录修改的文件copy一份到Index区域。
![](https://res.mrdear.cn/1540047927.png)

**3. git commit**
Commit之后Head对应的本地分支中也会多一份文件镜像。
![](https://res.mrdear.cn/1540047986.png)
...
### 变基Rebase
![](https://res.mrdear.cn/1539960913.png)
...
![](https://res.mrdear.cn/1539961166.png)
